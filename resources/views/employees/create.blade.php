...
<body>
    ...
    <div class="form-card">
        ...
        <div class="form-body">
            ...
            <div class="form-subtitle">Fill in the details below to add a new employee record.</div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="FirstName"
                               ...
                               value="{{ old('FirstName') }}" placeholder="e.g. Juan" maxlength="30">
                        @error('FirstName')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="LastName"
                               ...
                               value="{{ old('LastName') }}" placeholder="e.g. dela Cruz" maxlength="30">
                        @error('LastName')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="MiddleName"
                               ...
                               value="{{ old('MiddleName') }}" placeholder="e.g. Santos" maxlength="30">
                        @error('MiddleName')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="NameExtension"
                               ...
                               value="{{ old('NameExtension') }}" placeholder="e.g. Jr., Sr., III" maxlength="30">
                        @error('NameExtension')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="CivilStatus" class="{{ $errors->has('CivilStatus') ? 'is-invalid' : '' }}">
                            @foreach(['Single','Married','Widowed','Separated'] as $status)
                                <option value="{{ $status }}" {{ old('CivilStatus', 'Single') === $status ? 'selected' : '' }}>
                                    {{ $status }}
                                </option>
                            @endforeach
                        </select>
